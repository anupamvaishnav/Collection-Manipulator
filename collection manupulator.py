...
while True:
    ...
    match choice:
        ...
        case "3":   # Update Student
            ...
            name = input(f"Enter new Name ({students[sid]['Name']}): ") or students[sid]['Name']
            age = input(f"Enter new Age ({students[sid]['Age']}): ")
            grade = input(f"Enter new Grade ({students[sid]['Grade']}): ") or students[sid]['Grade']
            dob = input(f"Enter new DOB ({students[sid]['DOB']}): ") or students[sid]['DOB']
